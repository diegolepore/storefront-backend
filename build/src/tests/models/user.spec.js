...
describe('👤 User Model suite', function () {
    ...
    it('should have a delete method', function () {
        expect(user_1.UserStore.delete).toBeDefined();
    });
    ...
    it('index method should return a list of users', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_1.UserStore.index()];
                case 1:
                    result = _a.sent();
                    if (result) {
    ...
    it('show method should return the correct user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_1.UserStore.show(String(userId))];
                case 1:
                    result = _a.sent();
                    if (result) {
                        expect(result.first_name).toBe(user.first_name);
    ...
    it('delete method should remove the user', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, user_1.UserStore.delete(String(userId))];
                case 1:
                    deletedUser = _a.sent();
                    if (deletedUser) {
