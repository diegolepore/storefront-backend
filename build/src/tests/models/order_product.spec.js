...
describe('👽 Order products model suite', function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var u, response, p, o, orderResponse;
    ...
    it('should have an create method', function () {
        expect(order_product_1.OrderProductStore.create).toBeDefined();
    });
    it('Should add order and product id', function () { return __awaiter(void 0, void 0, void 0, function () {
        var orderProd, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    orderProd = {
                    ...
                    return [4 /*yield*/, order_product_1.OrderProductStore.create(orderProd.quantity, String(order.id), orderProd.product_id)];
                case 1:
                    result = _a.sent();
