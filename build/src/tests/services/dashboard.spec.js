...
describe('👾 Dashboard model suite', function () {
    beforeAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        var responseAuth, p, responseOrder;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    userFromJWT = jsonwebtoken_1.default.decode(access_token).user;
                    return [4 /*yield*/, request
                            .post('/orders')
    ...
    it('should have an currentOrderByUser method', function () {
        expect(dashboard_1.DashboardQueries.currentOrderByUser).toBeDefined();
    });
    it('should have a productsInOrders method', function () {
        expect(dashboard_1.DashboardQueries.productsInOrders).toBeDefined();
    });
    it('Should get active order by user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dashboard_1.DashboardQueries.currentOrderByUser(String(userFromJWT.id))];
                case 1:
                    result = _a.sent();
                    if (result) {
    ...
    it('Should get products in orders', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, dashboard_1.DashboardQueries.productsInOrders()];
                case 1:
                    result = _a.sent();
